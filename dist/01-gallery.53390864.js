...
function addElement() {
    return (0, _galleryItems.galleryItems).map((items)=>`<a class="gallery__item" href="${items.original}">
            <img
...
gallery.insertAdjacentHTML("afterbegin", addElement((0, _galleryItems.galleryItems)));
